  ...
  new Hono()
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all OpenTerminal sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific OpenTerminal session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new OpenTerminal session for interacting with AI assistants and managing conversations.",
